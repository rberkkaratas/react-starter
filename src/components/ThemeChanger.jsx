...
export default function ThemeChanger() {
    const [isDark, setIsDark] = useState(false); // initial theme is light
    ...
    return (
        <div>
            <div class="flex flex-col justify-center mr-2 mt-2" onClick={toggleTheme}>
                <input type="checkbox" name="light-switch" class="light-switch sr-only" />
                <label class="relative cursor-pointer p-2" for="light-switch">
                    {isDark ? <svg width="16" height="18" xmlns="http://www.w3.org/2000/svg">
                    ...
                    </svg> : <svg width="16" height="18" xmlns="http://www.w3.org/2000/svg">
